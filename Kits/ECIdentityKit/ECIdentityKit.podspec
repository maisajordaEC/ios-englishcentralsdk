Pod::Spec.new do |s|
  ...
  # s.source_files = "ECIdentityKit/*.{h,m,swift}"
  s.header_dir = "ECIdentityKit"
  s.module_name = "ECIdentityKit"
  ...
  s.dependency 'FBSDKCoreKit', '4.39.1' #Test dependency - remove if not needed
