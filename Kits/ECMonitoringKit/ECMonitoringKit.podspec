Pod::Spec.new do |s|
  ...
  # s.source_files = "ECMonitoringKit/*.{h,m,swift}"
  s.header_dir = "ECMonitoringKit"
  s.module_name = "ECMonitoringKit"
  ...
  s.dependency 'NewRelicAgent', '6.5.0' #Test dependency - remove if not needed
